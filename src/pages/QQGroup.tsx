    ...
    <>
      ...
      <FramedSection className="py-12 md:py-16" containerClassName="max-w-3xl">
        <div className="space-y-6">
          {groups.map((group) => (
            <Card key={group.number} className="gap-0 overflow-hidden p-0">
              <CardContent className="p-0">
                <div className="flex flex-col md:flex-row">
                  <div className="flex items-center justify-center bg-muted/40 p-8 md:w-48">
                  ...
                  <div className="flex-1 p-6 md:p-8">
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <Button
                        render={<a href={group.joinUrl} target="_blank" rel="noopener noreferrer" />}
                      >
